...
fileprivate extension Dialog {
    ...
    fileprivate func animateStackView(completionBlock: Dialog.VoidClosure? = nil,
    ...
    fileprivate func updateConstraints(showImage: Bool, completion: Dialog.VoidClosure? = nil) {
...
public extension UIViewController {
    ...
    ///   - image: The Image that will be set on the dialog.
    /// - Returns: Dialog
    @discardableResult public func show(alert title: String,
                                        message: String,
    ...
    ///   - image: The Image that will be set on the dialog.
    /// - Returns: Dialog
    @discardableResult public func show(loading title: String,
                                        message: String,
                                        image: UIImage?) -> Dialog {
...
public extension Dialog {
    ...
    ///   - image: The Image that will be set on the dialog.
    /// - Returns: Dialog
    @discardableResult public class func alert(title: String,
                            message: String,
    ...
    ///   - image: The Image that will be set on the dialog.
    /// - Returns: Dialog
    @discardableResult public class func loading(title: String,
                              message: String,
                              image: UIImage? =  nil) -> Dialog {
